...
@Testcontainers
class HabitRepositorySpringImplTest {
    @Container
    ...
    public static void initConnection() throws Exception {
        ...
        liquibase.run();
        UserRepository userRepository = new UserRepositorySpringImpl(connection);
        user = new User(0, "Arcady@mail.ru", "password", "resetPassword", "Arcady", Role.CLIENT, false);
        userRepository.create(user);
        habitRepository = new HabitRepositorySpringImpl(connection, userRepository);
