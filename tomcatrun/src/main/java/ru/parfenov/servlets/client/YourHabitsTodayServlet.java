 ...
 */
@Slf4j
@WebServlet(name = "YourHabitsTodayServlet", urlPatterns = "/habits-your-list-today")
public class YourHabitsTodayServlet extends HttpServlet implements MethodsForServlets {
    private final UserService userService;
    private final HabitService habitService;

    public YourHabitsTodayServlet() throws Exception {
        userService = ServiceLoading.loadUserService();
        habitService = ServiceLoading.loadHabitService();
    }

    public YourHabitsTodayServlet(UserService userService, HabitService habitService) {
