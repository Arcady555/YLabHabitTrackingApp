 ...
 * Создан в расчёте на то, что емайл приложения базируется на Mail.ru. Там можно
 * ввести параметр "пароли приложений". Мы указали его в поле Utility.mailPassword
 */
@Slf4j
